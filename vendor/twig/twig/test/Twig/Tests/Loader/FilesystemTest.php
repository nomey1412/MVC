...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/index.blade.php', $loader->getSourceContext('errors/index.blade.php')->getName());
        $this->assertEquals(realpath($path.'/errors/index.blade.php'), realpath($loader->getSourceContext('errors/index.blade.php')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('index.blade.php')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/index.blade.php')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/index.blade.php')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for index.blade.php in the named namespace
        $namedSource = $loader->getSourceContext('@named/index.blade.php')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get index.blade.php from the main namespace
