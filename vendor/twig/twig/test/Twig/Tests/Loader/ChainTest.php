...
class Twig_Tests_Loader_ChainTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetSourceContext()
    {
        ...
        $loader = new Twig_Loader_Chain(array(
            new Twig_Loader_Array(array('foo' => 'bar')),
            new Twig_Loader_Array(array('errors/index.blade.php' => 'baz')),
        ...
        $this->assertSame('', $loader->getSourceContext('errors/index.blade.php')->getPath());
        $this->assertEquals('baz', $loader->getSourceContext('errors/index.blade.php')->getCode());
