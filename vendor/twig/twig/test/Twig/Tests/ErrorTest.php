...
EOHTML
        ...
        try {
            ...
            $this->assertEquals('Variable "foo" does not exist in "index.blade.php" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('index.blade.php', $e->getSourceContext()->getName());
        }
    }
...
EOHTML
        ...
        try {
            ...
            $this->assertEquals('An exception has been thrown during the rendering of a template ("Runtime error...") in "index.blade.php" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('index.blade.php', $e->getSourceContext()->getName());
        }
    }
    ...
    public function testTwigExceptionGuessWithMissingVarAndFilesystemLoader()
    {
        ...
        try {
            ...
            $this->assertEquals(strtr(dirname(__FILE__).'/Fixtures/errors/index.blade.php', '/', DIRECTORY_SEPARATOR), $e->getFile());
        }
    }
